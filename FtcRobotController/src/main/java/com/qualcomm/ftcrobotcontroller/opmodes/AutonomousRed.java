...
public class AutonomousRed extends LinearOpMode {
    ...
    public void runOpMode () throws InterruptedException {
        ...
        int y = 0;
        //Distance array here
        //While loop with incrementing i
        //If wanting to do a special movement besides going straight just do if(i == 0) { do ahjkfhsa}
        int [] Distance = {4000,7000,0};


        telemetry.addData("Text", "*** Robot Data***");
        telemetry.addData("arm", "arm:  " + String.format("%.2f", Distance[1]));
        ...
        while (y < 3)
        {
            //motorEnc1.runToPosition(Distance[i];
            if(y == 0)
            {
                //do turn
            }
